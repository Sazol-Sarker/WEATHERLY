...
const getWeatherReport = (city) => {
    ...
    fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + city, options)
        ...
        .then(response => {
            ...
            //7
            cloud_pctct7.innerHTML = response.cloud_pct
            tempct7.innerHTML = response.temp
            feels_likect7.innerHTML = response.feels_like
            humidityct7.innerHTML = response.humidity
            wind_speedct7.innerHTML = response.wind_speed
            sunrisect7.innerHTML = response.sunrise
            sunsetct7.innerHTML = response.sunset
